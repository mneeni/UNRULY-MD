...
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'UNRULY';
    const packname = process.env.STICKER_PACKNAME || 'codesins';
const dev = process.env.DEV || '254798214068'
...
const admin = process.env.ADMIN_MSG || '𝐅𝐚𝐢𝐥𝐮𝐫𝐞!, 𝐘𝐨𝐮 𝐚𝐫𝐞 𝐭𝐨𝐨 𝐲𝐨𝐮𝐧𝐠 𝐭𝐨 𝐝𝐨 𝐭𝐡𝐚𝐭🦄';
    ...
    const botAdmin = process.env.BOT_ADMIN_MSG || 'you might want to watch your mouth'
    const NotOwner = process.env.NOT_OWNER_MSG || 'stfu you aint UNRULY ';
